...
% =========================================================================
% ===          若需要重新计算 cnnPooledFeatures, 请运行该部分代码         ===
% =========================================================================
tic();
...
% softmaxTrain 默认参数携带了截距项信息
softmaxModel = softmaxTrain(numel(pooledFeaturesTrain) / numTrainImages + 1,...
    numClasses, softmaxLambda, [softmaxX;ones(1,numTrainImages)], softmaxY, options);
...
% softmaxPredict 默认参数携带了截距项信息
[pred] = softmaxPredict(softmaxModel, [softmaxX;ones(1,numTestImages)]);
